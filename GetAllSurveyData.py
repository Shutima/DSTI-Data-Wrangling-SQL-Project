...
class SQLDatabase:
    ...
    def __init__(self, view_Name, export_file_path):
        self.sql_conn = odbc.connect(DRIVER='{ODBC Driver 17 for SQL Server}',
                                    SERVER='LAPTOP-NAD8U5G4',
    ...
    # Function to compare the current Survey Stucture data, if it's different than the saved Survey Structure, then activate the trigger
    # Else, do nothing
