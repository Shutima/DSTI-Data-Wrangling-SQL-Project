...
def main():
    ...
    mydb = GetAllSurveyData.SQLDatabase(get_view_name, get_export_csv_filename)
    ...
    if mydb.compareSavedAndNewSurveyStructure(df_savedSurveyStructure2, df_newSurveyStructure) == True:
        print('New SurveyStructure is different than saved one, need to trigger view')
